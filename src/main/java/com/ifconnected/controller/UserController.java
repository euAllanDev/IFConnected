...
public class UserController {
    ...
    public UserController(UserService userService, GeoFeedService geoFeedService) {
    ...
    // LIMPO: A lógica de upload agora está no Service
    ...
    // LIMPO: A lógica de notificação foi pro Service
